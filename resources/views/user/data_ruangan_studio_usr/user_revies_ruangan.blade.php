...
@section('MainContent')
    ...
    <a href="{{ url('/data_ruangan_studio') }}"><button class="btn btn-warning icon icon-left text-white mb-4"><i
                class="bi bi-left-arrow"></i>
            Kembali</button>
    </a>

    @if ($data_ruangan == null)
        <p>tidak ada data...</p>
    @else
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text">Fasilitas = {{ $data_ruangan->fasilitas }}</p>
