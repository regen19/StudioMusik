    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="staticBackdropLabel">Detail Pesanan Jadwal Alat</h1>
...
@push('script')
    <script>
        ...
        function show_byID(id_pesanan_jadwal_alat) {
            id_pesanan_alat = id_pesanan_jadwal_alat
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('input[type="radio"][name="rating2"][value="' + response.rating + '"]').prop('checked',
                        true);
                    $("#id_pesanan_jadwal_alat1").val(response.id_pesanan_jadwal_alat)
                    ...
                    if (response.status_persetujuan === "P") {
                        $("#btnProses").html(`<button type="button" class="btn btn-success" onclick="data_status(${response.id_pesanan_jadwal_alat})"
                    data-bs-toggle="modal" data-bs-target="#status_jadwal_alat">Proses</button>`)
                        status1 = "Pengajuan"
                        color1 = "warning"
        ...
        // function get_snap_token(id_pesanan_jadwal_alat) {
        ...
        //                     location.href = '/jadwal_alat_saya'

        //                     $.ajax({
        //                         url: `{{ url('/pembayaran_alat_sukses') }}`,
        //                         method: 'post',
        //                         dataType: 'json',
        //                         data: {
